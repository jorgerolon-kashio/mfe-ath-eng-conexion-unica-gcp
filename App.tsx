    ...
    <div className="bg-background-light dark:bg-background-dark font-display text-text-main antialiased h-screen overflow-hidden flex">
      <aside className="w-72 bg-white dark:bg-[#1a202c] border-r border-border-light flex flex-col h-full shrink-0 z-20">
        ...
        <nav className="flex-1 overflow-y-auto px-4 py-6 flex flex-col gap-2">
          <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-secondary hover:bg-background-light hover:text-text-main transition-colors group" href="#">
            <span className="material-symbols-outlined text-[20px] text-text-secondary group-hover:text-text-main">dashboard</span>
          ...
          <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-primary transition-colors" href="#">
            ...
            <span className="text-sm font-bold">Gestión de Empresas</span>
          </a>
          <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-secondary hover:bg-background-light hover:text-text-main transition-colors group" href="#">
            <span className="material-symbols-outlined text-[20px] text-text-secondary group-hover:text-text-main">person_add</span>
            <span className="text-sm font-medium">Onboarding</span>
          </a>
          <div className="my-2 border-t border-border-light/50"></div>
          <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-secondary hover:bg-background-light hover:text-text-main transition-colors group" href="#">
            <span className="material-symbols-outlined text-[20px] text-text-secondary group-hover:text-text-main">settings</span>
            <span className="text-sm font-medium">Configuración</span>
          </a>
          <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-secondary hover:bg-background-light hover:text-text-main transition-colors group" href="#">
            <span className="material-symbols-outlined text-[20px] text-text-secondary group-hover:text-text-main">shield</span>
